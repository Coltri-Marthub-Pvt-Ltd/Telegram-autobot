        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderTab2() {
                ...
                <div class="no-data">
                    ...
                    <p>There are no groups to display in Tab 2.</p>
                </div>
            `;
                    return;
                }
                ...
                let html = `<table class="table table-hover align-middle">
                        <thead>
                        <tr><th>Group ID</th><th>Group Name</th><th>Action</th></tr>
                        </thead><tbody>`;
                tab2Data.forEach((row, index) => {
                    html += `<tr data-index="${index}">
                        ...
                        <td>${row.groupName}</td>
                        <td>
                        <button class='btn btn-delete btn-sm delete-btn' data-index="${index}"><i class='fas fa-trash me-1'></i> Delete</button>
                        </td>
                    </tr>`;
                });
                html += `</tbody></table>`;
                ...
                document.querySelectorAll('.delete-btn').forEach(btn => {
                    btn.addEventListener('click', function() {
                        ...
                        setTimeout(() => {
                            alert("Group " + tab2Data[idx].groupName + " deleted!");
                            tab2Data.splice(idx, 1);
                            renderTab2();
                        }, 200);
                    });
                });
